...
* The original package name 'br.com.famptech.my-gateway' is invalid and this project uses 'br.com.famptech.my_gateway' instead.
...
```
$ docker run --rm my-gateway:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/my-gateway
```
